...
Обновлено: 2026-08-30. Версия этапа: `0.11.0-alpha.4`; публикация в
release candidate: `0.11.0-alpha.5`.

**Статус: code complete в единой non-stacked ветке
`feat/sync-v1-alpha5-release`; field validation pending.**

Исторический Draft PR #21 содержит ранний C3 без части remediation. Terminal
`rejected`, delete/restore race с tombstones, capability-флаг route-валидации,
invariant guards и трёхклиентный compensating restore включены в объединённый
alpha.5 RC; #21 отдельно не является merge-кандидатом.

...
## 0.9.0-alpha.3 - 2026-08-11

### Добавлено
- **FAB-кнопка сохранения**: плавающая кнопка «+» с анимацией и haptic-откликом
- **Автфокус**: клавиатура открывается сразу при запуске приложения
- **Haptic feedback**: тактильный отклик при сохранении и удалении записей
- **Диалог разрешения микрофона**: всплывающее окно с объяснением перед запросом доступа
- **Улучшенные карточки записей**: цветная полоса слева и бейджи типа (Задача/Мысль/Заметка)
- **Capacitor нативная интеграция**: StatusBar и SplashScreen с тёмной темой

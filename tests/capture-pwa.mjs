...
// Test 17: version and cache are 0.13.0-alpha.2
const { APP_VERSION } = await import('../js/version.js');
assert(APP_VERSION === '0.13.0-alpha.2', 'Test 17: version should be 0.13.0-alpha.2');
assert(swContent.includes("const CACHE_NAME = 'atlas-capture-0.13.0-alpha.2'"), 'Test 17: SW cache should be 0.13.0-alpha.2');
...
console.log('✓ Test 17: version and cache are 0.13.0-alpha.2');
